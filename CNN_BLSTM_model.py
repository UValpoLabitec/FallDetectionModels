...
class CONV_BLSTM_model():
	"""
	A convolutional recurrent NN model implementation using a 
	...
	def create_network(self):
		...
		self.network.add(Bidirectional(LSTM(50, kernel_initializer='glorot_uniform', 
...
model = CONV_BLSTM_model("conv_blstm_modelv2")
